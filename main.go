...
func main() {
	...
	daemonCommand.PersistentFlags().String(f.Service.IngressController.Namespace, "default", "Namespace in which the ingress-controller to manage runs in.")
	daemonCommand.PersistentFlags().String(f.Service.IngressController.Service, "ingress-controller", "Name of the Kubernetes service resource of the ingress-controller the operator should manage.")
