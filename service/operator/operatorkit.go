...
type Operator interface {
	...
	// expects when reconciling delete operations. On create and delete events the
	// operator might need to reconcile resources by removing them. GetDeleteState
	// will receive as desiredState. This is to align to the general concept of
	// reconciliation regardless creation or deletion events.
