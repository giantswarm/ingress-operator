...
func (s *Service) GetCreateState(obj, currentState, desiredState interface{}) (interface{}, error) {
	...
	if !ok {
		return nil, microerror.MaskAnyf(wrongTypeError, "expected '%T', got '%T'", &apiv1.ConfigMap{}, currentState)
	}
	dState, ok := desiredState.(map[string]string)
	if !ok {
		return nil, microerror.MaskAnyf(wrongTypeError, "expected '%T', got '%T'", map[string]string{}, desiredState)
	}
...
func (s *Service) ProcessCreateState(obj, createState interface{}) error {
	...
	if !ok {
		return microerror.MaskAnyf(wrongTypeError, "expected '%T', got '%T'", &apiv1.ConfigMap{}, createState)
	}
...
func (s *Service) ProcessDeleteState(obj, deleteState interface{}) error {
	...
	if !ok {
		return microerror.MaskAnyf(wrongTypeError, "expected '%T', got '%T'", &apiv1.ConfigMap{}, deleteState)
	}
